...
public class TavParsad extends SlidingFragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		sggs.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				constant.sggsMethod(parent, view, position, id, TavParsad.this);
			}
		}); 
		...
		general.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				toggle();
				constant.generalMethod(parent, view, position, id, TavParsad.this);
			}
		}); 
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			...
			return "Tav Parsad Swaiye";
		}
	}

	@SuppressLint("ValidFragment")
	public static class Tav extends Fragment {
		public Tav() {
		}
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
			...
			try {
				...
				webview.loadUrl("file:///android_asset/OtherBanis/TavParsad.html");
