...
public class GurbaniOnly extends SlidingFragmentActivity {
    SectionsPagerAdapter mSectionsPagerAdapter;
    static TransitionViewPager mViewPager;
    static SharedPreferences getPrefs;
    public static final String MyPREFERENCES = "MyPrefs";
    public static final String Num = "gurbani_page_num";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sggs.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                constant.sggsMethod(parent, view, position, id, GurbaniOnly.this);
            }
        });
        ...
        general.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                toggle();
                constant.generalMethod(parent, view, position, id, GurbaniOnly.this);
            }
        });
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            Fragment gurbani = new GurbaniAng(position);
            mViewPager.setObjectForPosition(gurbani, position);
            return gurbani;
        }
    ...
    public static class GurbaniAng extends Fragment {
        ...
        public GurbaniAng(int position) {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            search.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (!(number.getText().toString().equals(""))) {
                        ...
                        GurbaniOnly.mViewPager.setCurrentItem(num);
                    }
            ...
            try {
                ...
                editor.commit();
                webview.loadUrl("file:///android_asset/gurmukhi_html/" + position + ".html");
