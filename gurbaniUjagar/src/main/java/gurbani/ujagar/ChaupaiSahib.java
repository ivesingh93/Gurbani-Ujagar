...
public class ChaupaiSahib extends SlidingFragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		sggs.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				constant.sggsMethod(parent, view, position, id, ChaupaiSahib.this);
			}
		}); 
		...
		general.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {	
				toggle();
				constant.generalMethod(parent, view, position, id, ChaupaiSahib.this);			
			}
		}); 
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			return "Chaupai Sahib";
		}
	}

	@SuppressLint("ValidFragment")
	public static class Chaupai extends Fragment {
		public Chaupai() {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
			...
			try {
				webview.loadUrl("file:///android_asset/OtherBanis/Chaupai Sahib.html");
