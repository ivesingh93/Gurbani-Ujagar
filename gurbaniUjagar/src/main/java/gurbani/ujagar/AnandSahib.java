...
public class AnandSahib extends SlidingFragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		sggs.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				constant.sggsMethod(parent, view, position, id, AnandSahib.this);
			}
		}); 
		...
		general.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				toggle();
				constant.generalMethod(parent, view, position, id, AnandSahib.this);
			}
		}); 
	...
	public static class Anand extends Fragment {
		public Anand() {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
			...
			try {
				...
				webview.loadUrl("file:///android_asset/OtherBanis/Anand Sahib.html");
