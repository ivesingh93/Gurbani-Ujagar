...
public class SukhmaniSahib extends SlidingFragmentActivity {
	SectionsPagerAdapter mSectionsPagerAdapter;
	static TransitionViewPager mViewPager;
	static SharedPreferences getPrefs;
	public static final String MyPREFERENCES = "MyPrefs" ;
	public static final String Num = "sukhmani_page_num"; 
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		sggs.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				constant.sggsMethod(parent, view, position, id, SukhmaniSahib.this);
			}
		}); 
		...
		general.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				toggle();
				constant.generalMethod(parent, view, position, id, SukhmaniSahib.this);	
			}
		}); 
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int position) {
			Fragment sukhmani = new Sukhmani(position);
			mViewPager.setObjectForPosition(sukhmani, position);
			return sukhmani;
		}
	...
	public static class Sukhmani extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
			...
			search.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					if (!(number.getText().toString().equals(""))) {
						...
						SukhmaniSahib.mViewPager.setCurrentItem(num);
					}
					webview.reload();
					number.setText("");
				}
			...
			try {
				...
				editor.commit(); 
				webview.loadUrl("file:///android_asset/Sukhmani Sahib/"+ position + ".html");
