...
public class SahibSingh extends SlidingFragmentActivity {

	SectionsPagerAdapter mSectionsPagerAdapter;
	static TransitionViewPager mViewPager;
	static SharedPreferences getPrefs;
	public static final String MyPREFERENCES = "MyPrefs" ;
	public static final String Num = "sahib_page_num"; 
	static SharedPreferences sharedpreferences;
	static final ArrayList<String> AngList = new ArrayList<String>();
	ImageView logo;
	ImageButton img, home, play, stop, pause;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		sggs.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				constant.sggsMethod(parent, view, position, id, SahibSingh.this);
			}
		}); 
		...
		general.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				toggle();
				constant.generalMethod(parent, view, position, id, SahibSingh.this);		
			}
		}); 
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int position) {
			Fragment sahibAng = new SahibAng(position);
			mViewPager.setObjectForPosition(sahibAng, position);
			return sahibAng;
		}
	...
	public static class SahibAng extends Fragment{
		private int position, num, x = 0;
		ImageButton maxmin, show;
		public SahibAng() {
		}
		public SahibAng(int position) {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
			...
			search.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					if (!(number.getText().toString().equals(""))) {
						...
						SahibSingh.mViewPager.setCurrentItem(num);
					}
					webview.reload();
					number.setText("");
				}
			...
			try {
				...
				editor.commit(); 
				webview.loadUrl("file:///android_asset/sahibsingh/" + position + ".html");
