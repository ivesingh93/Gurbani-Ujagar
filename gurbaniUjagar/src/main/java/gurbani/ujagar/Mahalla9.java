...
public class Mahalla9 extends SlidingFragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		sggs.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				constant.sggsMethod(parent, view, position, id, Mahalla9.this);
			}
		}); 
		...
		general.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				toggle();
				constant.generalMethod(parent, view, position, id, Mahalla9.this);		
			}
		}); 
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {	
			return "Salok Mahalla 9";
		}
	}

	@SuppressLint("ValidFragment")
	public static class Mahalla extends Fragment {
		public Mahalla() {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
			...
			try {
				webview.loadUrl("file:///android_asset/OtherBanis/Salok Mahalla 9.html");
