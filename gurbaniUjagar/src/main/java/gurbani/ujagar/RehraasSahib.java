...
public class RehraasSahib extends SlidingFragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		sggs.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				constant.sggsMethod(parent, view, position, id, RehraasSahib.this);
			}
		}); 
		...
		general.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				toggle();
				constant.generalMethod(parent, view, position, id, RehraasSahib.this);				
			}
		}); 
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {			
			return "Rehraas Sahib";
		}
	}

	@SuppressLint("ValidFragment")
	public static class Rehraas extends Fragment {
		public Rehraas() {
		}
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
			...
			try {
				webview.loadUrl("file:///android_asset/OtherBanis/RehraasSahib.html");
