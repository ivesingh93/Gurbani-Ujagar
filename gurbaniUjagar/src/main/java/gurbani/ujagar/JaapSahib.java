...
public class JaapSahib extends SlidingFragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		sggs.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				constant.sggsMethod(parent, view, position, id, JaapSahib.this);
			}
		}); 
		...
		general.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				toggle();
				constant.generalMethod(parent, view, position, id, JaapSahib.this);	
			}
		}); 
	...
	public static class Jaap extends Fragment {
		public Jaap() {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
			...
			try {
				webview.loadUrl("file:///android_asset/OtherBanis/Jaap Sahib.html");
