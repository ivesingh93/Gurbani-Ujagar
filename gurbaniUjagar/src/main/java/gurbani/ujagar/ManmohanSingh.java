...
public class ManmohanSingh extends SlidingFragmentActivity {
	SectionsPagerAdapter mSectionsPagerAdapter;
	static TransitionViewPager mViewPager;
	static SharedPreferences getPrefs;
	public static final String MyPREFERENCES = "MyPrefs" ;
	public static final String Num = "manmohan_page_num"; 
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		sggs.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				constant.sggsMethod(parent, view, position, id, ManmohanSingh.this);
			}
		}); 
		...
		general.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				toggle();
				constant.generalMethod(parent, view, position, id, ManmohanSingh.this);
			}
		}); 	
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int position) {
			...
			mViewPager.setObjectForPosition(manmohanAng, position);
			return manmohanAng;
		}
	...
	public static class ManmohanAng extends Fragment{
		...
		public ManmohanAng(int position) {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
			...
			search.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					if (!(number.getText().toString().equals(""))) {
						...
						ManmohanSingh.mViewPager.setCurrentItem(num);
					}
			...
			try {
				...
				editor.commit(); 
				webview.loadUrl("file:///android_asset/manmohansingh/"+ position + ".html");
