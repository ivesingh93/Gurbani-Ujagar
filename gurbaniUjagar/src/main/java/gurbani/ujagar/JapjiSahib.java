...
public class JapjiSahib extends SlidingFragmentActivity {
	SectionsPagerAdapter mSectionsPagerAdapter;
	static TransitionViewPager mViewPager;
	static SharedPreferences getPrefs;
	public static final String MyPREFERENCES = "MyPrefs" ;
	public static final String Num = "japji_page_num"; 
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		sggs.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				constant.sggsMethod(parent, view, position, id, JapjiSahib.this);
		...
		general.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				toggle();
				constant.generalMethod(parent, view, position, id, JapjiSahib.this);	
			}
		}); 
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int position) {
			...
			Fragment japji = new Japji(position);
			mViewPager.setObjectForPosition(japji, position);
	...
	public static class Japji extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
			...
			search.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					if (!(number.getText().toString().equals(""))) {
						...
						JapjiSahib.mViewPager.setCurrentItem(num);
					}
			...
			try {
				...
				editor.commit(); 
				webview.loadUrl("file:///android_asset/Japji Sahib/" + position+ ".html");
